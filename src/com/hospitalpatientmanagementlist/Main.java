...
public class Main {
	...
	/**
	 * Method to show message Invalid option
	 */
	...
	private static void deletePatient() {
		try {
			...
			System.out.println("\n\n\nThe patient has been deleted with success!\n\n\n");
		} catch (Exception e) {
	...
	private static Integer readPatientPIDNumber() {
		while (true) {
			try {
				System.out.println("Inform the PID Number:");
				Scanner scanner = getScanner();
				Integer pIDNumber = scanner.nextInt();
				scanner.nextLine();
				return pIDNumber;
			} catch (Exception e) {
				System.out.println("Invalid PID Number! Please, try again.");
			}
		}
	...
	private static Integer readPositionList() {
		while (true) {
			try {
				System.out.println("Inform the position:");
				Scanner scanner = getScanner();
	...
	/**
	 * Method to show message created with success
	 */
	...
	private static void updatePatientInformation() {
		...
		try {
			...
			System.out.println("\n\n\nThe patient has been updated with success!\n\n\n");
		} catch (Exception e) {
			System.out.println(e.getMessage());
		}
	...
	/**
	 * Method to verify if PID Number already exist in the list
	 * 
	 * @param pIDNumber
	 * @return boolean
	 */
	...
	private static Patient readPatientInformation(Patient patient) {
		...
		System.out.println("Inform the first name:");
		Scanner scanner = getScanner();
		String firstName = scanner.nextLine();
		patient.setFirstName(firstName);

		System.out.println("Inform the last name:");
		String lastName = scanner.nextLine();
		patient.setLastName(lastName);

		System.out.println("Inform the mobile number");
		...
		System.out.println("Inform the city:");
